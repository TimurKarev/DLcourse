    ...
    def fit(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            if np.not_equal(self.learning_rate_decay, 1.0):
                learning_rate = self.learning_rate * (1 / (1 + self.learning_rate_decay * epoch))
            ...
            for batch_indices in batches_indices:
                ...
                # the params
                loss = self.model.compute_loss_and_gradients(self.dataset.train_X,
                ...
                for param_name, param in self.model.params().items():
                    ...
                    param.value = optimizer.update(param.value, param.grad, learning_rate)
                    #print (param.value)
            ...
            #print("Epoch: %f  Loss: %f, Train accuracy: %f, val accuracy: %f" %
        ...
        return loss_history, train_acc_history, max(val_acc_history)
